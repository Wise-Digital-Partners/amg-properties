  ...
  return (
    <Layout>
      <SearchEngineOptimization
        title="South Park Property Management | AMG Props"
        description="Partner with AMG Props for premier property management in South Park. We'll handle your advertising, leasing, rent collection, accounting, and maintenance."
      ...
      >
        ...
        <p className="text-white text-xl mb-8">
          Stress less. Increase your revenue. Your South Park property and
        ...
        <div className="container">
          <div className="grid md:grid-cols-2 gap-y-8 md:gap-x-10 lg:gap-x-20 items-center">
            ...
            <div className="order-1 md:order-2">
              <h1>South Park Property Management Company</h1>
              <p>
                AMG Props can manage every aspect of your South Park investment
      ...
      <section className="mb-20 md:mb-30">
        <div className="container">
          <div className="grid md:grid-cols-2 gap-y-8 md:gap-x-10 lg:gap-x-20 items-center">
            ...
            <div>
              <h2>Why South Park Is A Great Place To Live</h2>
              <p>
                South Park is one of San Diego's most charming, close-knit
                neighborhoods. Residents enjoy easy access to one of the city's
                crown jewels, the 1,200-acre historic Balboa Park, and it's just
                a short hop, skip, and a jump to downtown San Diego and the
                beautiful San Diego Bay. At AMG Props, we love being part of the
                fabric of this beautiful community and a trusted property
                management company serving the area. If you own a rental in
                South Park, we'll find you great residents and help you earn on
                your investment.
              </p>
              <ButtonSolid
                modal="modal-rental-analysis"
...
export const query = graphql`
  {
    ...
    city: file(relativePath: { eq: "5.0 Cities/South Park.jpg" }) {
      childImageSharp {
        gatsbyImageData(layout: CONSTRAINED, width: 560)
      }
    }
