  ...
  return (
    <Layout>
      <SearchEngineOptimization
        title="Kensington Property Management | AMG Props"
        description="Partner with AMG Props for premier property management in Kensington. We'll handle your advertising, leasing, rent collection, accounting, and maintenance."
      ...
      >
        ...
        <p className="text-white text-xl mb-8">
          Stress less. Increase your revenue. Your Kensington property and
        ...
        <div className="container">
          <div className="grid md:grid-cols-2 gap-y-8 md:gap-x-10 lg:gap-x-20 items-center">
            ...
            <div className="order-1 md:order-2">
              <h1>Kensington Property Management Company</h1>
              <p>
                AMG Props can manage every aspect of your Kensington investment
      ...
      <section className="mb-20 md:mb-30">
        <div className="container">
          <div className="grid md:grid-cols-2 gap-y-8 md:gap-x-10 lg:gap-x-20 items-center">
            ...
            <div>
              <h2>Why Kensington Is A Great Place To Live</h2>
              <p>
                Anyone who spends time in the Kensington neighborhood knows the
                community's sense of pride in their corner of San Diego. It's a
                place where people walk their dogs, greet each other with
                ...
                thriving Kensington neighborhood, you can trust AMG Props to
...
export const query = graphql`
  {
    ...
    city: file(relativePath: { eq: "5.0 Cities/Kensington.jpg" }) {
      childImageSharp {
        gatsbyImageData(layout: CONSTRAINED, width: 560)
      }
    }
