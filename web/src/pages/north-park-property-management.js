  ...
  return (
    <Layout>
      <SearchEngineOptimization
        title="North Park Property Management | AMG Props"
        description="Partner with AMG Props for premier property management in North Park. We'll handle your advertising, leasing, rent collection, accounting, and maintenance."
      ...
      >
        ...
        <p className="text-white text-xl mb-8">
          Stress less. Increase your revenue. Your North Park property and
        ...
        <div className="container">
          <div className="grid md:grid-cols-2 gap-y-8 md:gap-x-10 lg:gap-x-20 items-center">
            ...
            <div className="order-1 md:order-2">
              <h1>North Park Property Management Company</h1>
              <p>
                AMG Props can manage every aspect of your North Park investment
      ...
      <section className="mb-20 md:mb-30">
        <div className="container">
          <div className="grid md:grid-cols-2 gap-y-8 md:gap-x-10 lg:gap-x-20 items-center">
            ...
            <div>
              <h2>Why North Park Is A Great Place To Live</h2>
              <p>
                North Park is one of the trendiest neighborhoods in San Diego
                and undoubtedly the place to be for young professionals and
                students. Residents enjoy the area's walkability, unique and
                eclectic eateries and boutiques, and lively nightlife. If you
                own a rental property in or around North Park, we can help you
                earn on your investment. And we provide you with exceptional
                landlord services to ensure your residents love their home. At
                AMG Props, we love being a trusted property management company
                serving the community of North Park.
              </p>
              <ButtonSolid
                modal="modal-rental-analysis"
                text="Free Rental Analysis"
...
export const query = graphql`
  {
    ...
    city: file(relativePath: { eq: "5.0 Cities/North Park.jpg" }) {
      childImageSharp {
        gatsbyImageData(layout: CONSTRAINED, width: 560)
      }
    }
